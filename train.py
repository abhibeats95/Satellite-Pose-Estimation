...
def run(cfg: DictConfig) -> None:
    ...
    cfg.callbacks.model_checkpoint.params.filename = os.getcwd() + cfg.callbacks.model_checkpoint.params.filename
    callbacks = []
...
@hydra.main(config_path='conf/cubesat', config_name='config')
